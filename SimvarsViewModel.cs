...
namespace Simvars
{
    ...
    public class SimvarsViewModel : BaseViewModel, IBaseSimConnectWrapper
    {
        ...
        private WatchServer watchServer = null;
        ...
        public string sWatchConnectButtonLabel
        {
            get { return m_sWatchConnectButtonLabel; }
            private set { this.SetProperty(ref m_sWatchConnectButtonLabel, value); }
        }
        private string m_sWatchConnectButtonLabel = "Start Watch Server";
        ...
        public BaseCommand cmdToggleWatchServerConnect { get; private set; }
        ...
        public SimvarsViewModel()
        {
            ...
            cmdToggleWatchServerConnect = new BaseCommand((p) => { ToggleWatchServer(); });
        ...
        private void ToggleWatchServer()
        {
            if (watchServer.isConnected)
            {
                watchServer.StopServer();
                sWatchConnectButtonLabel = "Start Watch Server";
            }
            else
            {
                watchServer.StartServer();
                sWatchConnectButtonLabel = "Stop Watch Server";
            }
        }
